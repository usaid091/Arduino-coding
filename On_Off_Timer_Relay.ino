...
if(time_m<0){time_m=15; time_h = time_h-1;}
}
...
if(time_m>15){time_m=0;}
if(time_h>02){time_h=0;}
...
if(time_m<0){time_m=15;}
if(time_h<0){time_h=2;}
if(set>0 && mode==1){write_on_time();}
if(set>0 && mode==2){write_of_time();}
delay(200); 
}
...
{digitalWrite(relay,flag3);
delay(500);
digitalWrite(relay,flag4);
delay(500);
digitalWrite(relay1,flag3);
delay(500);
digitalWrite(relay1,flag4);
delay(500);
}
else{
digitalWrite(relay, HIGH);
